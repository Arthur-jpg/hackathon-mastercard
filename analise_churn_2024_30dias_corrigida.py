...
"""
Análise de Churn 2024 - Versão Corrigida (30 dias de inatividade)
=================================================================
...
Critério de churn: Sem transações nos últimos 30 dias (desde 2024-11-30)
...
def analise_1_idade_churn(conn):
    """1. Análise de Churn por Faixa Etária - TODOS os clientes que saíram em 2024 (30 dias)"""
    print("\n" + "="*60)
    print("1. ANÁLISE DE CHURN POR FAIXA ETÁRIA (30 DIAS)")
    print("="*60)
    ...
    criar_grafico_churn(
        df, 
        'Análise de Churn por Faixa Etária\n(Todos os churns de 2024 - 30 dias inatividade)',
        'grafico_1_idade_churn_30dias_corrigido.png',
        'Faixa Etária'
    )
...
def analise_2_renda_churn(conn):
    """2. Análise de Churn por Faixa de Renda - TODOS os clientes que saíram em 2024 (30 dias)"""
    print("\n" + "="*60)
    print("2. ANÁLISE DE CHURN POR FAIXA DE RENDA (30 DIAS)")
    print("="*60)
    ...
    criar_grafico_churn(
        ...
        'grafico_2_renda_churn_30dias_corrigido.png',
        'Faixa de Renda'
    )
...
def analise_3_tempo_conta_churn(conn):
    """3. Análise de Churn por Tempo desde Criação da Conta - TODOS os clientes que saíram em 2024 (30 dias)"""
    print("\n" + "="*60)
    print("3. ANÁLISE DE CHURN POR TEMPO DESDE CRIAÇÃO DA CONTA (30 DIAS)")
    print("="*60)
    ...
    criar_grafico_churn(
        ...
        'grafico_3_tempo_conta_churn_30dias_corrigido.png',
...
def analise_4_conta_adicional_churn(conn):
    """4. Análise de Churn por Conta Adicional - TODOS os clientes que saíram em 2024 (30 dias)"""
    print("\n" + "="*60)
    print("4. ANÁLISE DE CHURN POR CONTA ADICIONAL (30 DIAS)")
    print("="*60)
    ...
    criar_grafico_churn(
        ...
        'grafico_4_conta_adicional_churn_30dias_corrigido.png',
...
def analise_5_estado_churn(conn):
    """5. Análise de Churn por Estado - TODOS os clientes que saíram em 2024 (30 dias)"""
    print("\n" + "="*60)
    print("5. ANÁLISE DE CHURN POR ESTADO (30 DIAS)")
    print("="*60)
    ...
    LEFT JOIN clientes_churn cc ON tc.cliente_id = cc.cliente_id
    GROUP BY tc.Estado
    HAVING COUNT(*) >= 15  -- Apenas estados com pelo menos 15 clientes (ajustado para 30 dias)
    ORDER BY 5 DESC;
    """
    ...
    criar_grafico_churn(
        ...
        'grafico_5_estado_churn_30dias_corrigido.png',
        'Estado'
    )
...
def analise_6_tipo_cartao_churn(conn):
    """6. Análise de Churn por Tipo de Cartão - TODOS os clientes que saíram em 2024 (30 dias)"""
    print("\n" + "="*60)
    print("6. ANÁLISE DE CHURN POR TIPO DE CARTÃO (30 DIAS)")
    print("="*60)
    ...
    criar_grafico_churn(
        df, 
        'Análise de Churn por Tipo de Cartão\n(Todos os churns de 2024 - 30 dias - Dados válidos desde 2023)',
        'grafico_6_tipo_cartao_churn_30dias_corrigido.png',
        'Tipo de Cartão'
    )
...
def analise_7_produto_mastercard_churn(conn):
    """7. Análise de Churn por Produto Mastercard - TODOS os clientes que saíram em 2024 (30 dias)"""
    print("\n" + "="*60)
    print("7. ANÁLISE DE CHURN POR PRODUTO MASTERCARD (30 DIAS)")
    print("="*60)
    ...
    criar_grafico_churn(
        ...
        'grafico_7_produto_mastercard_churn_30dias_corrigido.png',
        'Produto Mastercard'
    )
...
def analise_8_tempo_cartao_churn(conn):
    """8. Análise de Churn por Tempo desde Emissão do Cartão - TODOS os clientes que saíram em 2024 (30 dias)"""
    print("\n" + "="*60)
    print("8. ANÁLISE DE CHURN POR TEMPO DESDE EMISSÃO DO CARTÃO (30 DIAS)")
    print("="*60)
    ...
    criar_grafico_churn(
        ...
        'grafico_8_tempo_cartao_churn_30dias_corrigido.png',
...
def analise_9_limite_cartao_churn(conn):
    """9. Análise de Churn por Limite do Cartão - TODOS os clientes que saíram em 2024 (30 dias)"""
    print("\n" + "="*60)
    print("9. ANÁLISE DE CHURN POR LIMITE DO CARTÃO (30 DIAS)")
    print("="*60)
    ...
    criar_grafico_churn(
        ...
        'grafico_9_limite_cartao_churn_30dias_corrigido.png',
        'Faixa de Limite'
    )
...
def resumo_executivo_churn(conn):
    """Gera um resumo executivo completo da análise de churn corrigida (30 dias)"""
    print("\n" + "="*80)
    print("RESUMO EXECUTIVO - ANÁLISE DE CHURN 2024 (30 DIAS - VERSÃO CORRIGIDA)")
    print("="*80)
    ...
    print("\n📊 ESTATÍSTICAS GERAIS (30 DIAS INATIVIDADE):")
    print(f"• Total de clientes que já fizeram transações: {df_geral.iloc[0]['total_clientes_ativos_historico']:,}")
    print(f"• Clientes em churn (30 dias sem transação): {df_geral.iloc[0]['total_clientes_churn']:,}")
    ...
    print(f"\n🕐 ANÁLISE TEMPORAL DOS CHURNS (30 DIAS):")
...
def main():
    ...
    print("🚀 INICIANDO ANÁLISE DE CHURN 2024 - VERSÃO CORRIGIDA (30 DIAS)")
    print("="*80)
    ...
    print("📌 Critério: 30 dias de inatividade desde 30/11/2024")
    ...
    try:
        ...
        print("="*80)
        print("📁 Gráficos salvos com sufixo '_30dias_corrigido.png'")
        print("🎯 Esta versão captura o impacto real no marketshare de 2024")
        print("💡 Inclui clientes antigos que saíram em 2024 (30 dias de inatividade)")
